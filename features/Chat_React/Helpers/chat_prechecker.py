...
# Load all phrases
GREETING_PHRASES = load_phrases('Data/Data-Sets/greeting_phrases.json')
OPINION_PHRASES = load_phrases('Data/Data-Sets/opinion_phrases.json')
INSULT_PHRASES = load_phrases('Data/Data-Sets/insult_phrases.json')
STREAM_PHRASES = load_phrases('Data/Data-Sets/stream_phrases.json')
QUESTION_PHRASES = load_phrases('Data/Data-Sets/question_phrases.json')
